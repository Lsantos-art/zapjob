...
@section('content')
    <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        <div class="card-header card-header-success card-header-icon">
            ...
            <p class="card-category">Você tem: {{ $user->posts()->count() }} posts cadastrados</p>
            <h3 class="card-title">Bem vindo(a) ao Zap Job</h3>
            <a href="{{ route('master.posts.create') }}" class="btn btn-outline-info btn-sm">Anunciar</a>
        </div>
        </div>
    </div>
    ...
    @foreach ($posts as $post)
        <div class="card card-stats">
            ...
            <div class="container my-3">
                <a href="{{ route('master.postsEdit', $post->id) }}" class="btn btn-outline-info btn-sm">
                    Editar postagem
                </a>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <a href="{{ route('master.posts.destroy',  $post->id) }}" class="btn btn-danger">Sim, tenho certeza!</a>
                        </div>
                    </div>
                    </div>
                </div>
